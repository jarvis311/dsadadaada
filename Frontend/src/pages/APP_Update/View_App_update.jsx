    ...
    <Layout sidebar={true}>
      <div className="page-heading">
        ...
        <div className="page-heading-right">
          ...
          {
            permission["app_update"].includes(3) ?
          ...
          {
            permission["app_update"].includes(4) ?
        ...
        <Card>
          <Card.Body>
            <Row>
              ...
              <Col md={4}>
                <div className='mb-4'>
                  <p className='mb-0 fw-bold'>Start io Ads Enable</p><span>{Data.start_io_ads_enable == 1 ? "On" : "Off"}</span>
                </div>
              </Col>
              <Col md={4}>
                <div className='mb-4'>
                  <p className='mb-0 fw-bold'>Affilation Program Enable</p><span>{Data.affilation_program_enable == 1 ? "On" : "Off"}</span>
                </div>
              </Col>
            </Row>
          </Card.Body>
