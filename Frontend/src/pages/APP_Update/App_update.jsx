    ...
    <Layout sidebar={true}>
      <div className="page-heading">
        ...
        <div className="page-heading-right">
          ...
          />
           {
            permission["app_update"].includes(2)?
                ...
                <Table bordered responsive>
                  <thead>
                    <tr>
                      ...
                      <th width="14%" className='text-center'>Start Io ads Enable</th>
                      <th width="14%" className='text-center'>Affiliation Program Enable</th>
