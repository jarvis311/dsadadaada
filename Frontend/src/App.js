...
import NewRoleAdd from './pages/Role/NewRoleAdd';
...
const App = () => {
    ...
    return (
        <>
            <AuthContext.Provider value={{ permission, setPermission, classActive, setClassActive }}>
                <BrowserRouter>
                    <Routes>
                        ...
                        <Route element={<PrivetRoutes />}>
                            ...
                            <Route element={<Permission name="app_update" num={2} />}>
                                <Route path="/Add/app_update" element={<Add_App_update />} />
                            </Route>
                            <Route element={<Permission name="app_update" num={3} />}>
                            ...
                            <Route element={<Permission name="API_Priority" num={2} />}>
                                <Route path="/Add/API_Priority" element={<Add_Api_statuses />} />
                            </Route>

                            <Route element={<Permission name="API_Priority" num={3} />}>
                            ...
                            <Route element={<Permission name="Permission" num={1} />}>
                                ...
                                <Route path="/Add/Role" element={<NewRoleAdd />} />
